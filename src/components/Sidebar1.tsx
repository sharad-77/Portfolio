...
function Sidebar1() {
  ...
  return (
    <div className="h-[882px] w-[90px] text-center ml-auto">
      <div className="text-white h-full w-full flex flex-col items-center pr-6">
        ...
        <div className="flex flex-col space-y-5 mt-46">
          <button
            onClick={() => handleNavigation('/', 'user')}
        ...
        <div className="mt-auto mb-8">
          <button
            onClick={scrollToTop}
            className="w-10 h-10 flex items-center justify-center text-[#999999] hover:text-white hover:bg-[#121212] rounded-lg transition-all duration-200 hover:shadow-md cursor-pointer"
          >
